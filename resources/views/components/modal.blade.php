...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 overflow-hidden rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] text-[var(--color-text)] shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
