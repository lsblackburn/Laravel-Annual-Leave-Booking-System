                            ...
                            <tr class="hover:bg-[var(--color-surface-alt)] transition">
                                ...
                                <td
                                    ...
                                    @if ($request->status == 'pending')
                                        ...
                                        <form x-data action="{{ route('leave.delete', $request->id) }}" method="POST"
                        ...
                        <td colspan="5" class="text-center text-sm text-[var(--color-subtletext)]">
                            ...
                            @if (Auth::user()->remainingLeaveAllowance() > 0)
                                <a href="{{ route('leave.form') }}"
                                    class="inline-flex items-center justify-center w-full gap-2 px-6 py-4 cursor-pointer">
                            ...
                            @else
                                <div
                                    class="inline-flex items-center justify-center w-full gap-2 px-6 py-4 cursor-not-allowed opacity-50">

                                    No leave allowance remaining
                                </div>
                            @endif
